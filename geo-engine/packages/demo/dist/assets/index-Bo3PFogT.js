...
`].filter(us).join(`
`)),a=Ao(a),a=ll(a,e),a=cl(a,e),o=Ao(o),o=ll(o,e),o=cl(o,e),a=ul(a),o=ul(o),e.isRawShaderMaterial!==!0&&(M=`#version 300 es
...
`)+`
`+m);const v=M+p+a,E=M+m+o,L=ol(s,s.VERTEX_SHADER,v),b=ol(s,s.FRAGMENT_SHADER,E);s.attachShader(g,L),s.attachShader(g,b),e.index0AttributeName!==void 0?s.bindAttribLocation(g,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(g,0,"position"),s.linkProgram(g);function A(P){if(n.debug.checkShaderErrors){const k=s.getProgramInfoLog(g).trim(),O=s.getShaderInfoLog(L).trim(),X=s.getShaderInfoLog(b).trim();let W=!0,V=!0;if(s.getProgramParameter(g,s.LINK_STATUS)===!1)if(W=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,g,L,b);else{const $=hl(s,L,"vertex"),H=hl(s,b,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(g,s.VALIDATE_STATUS)+`
