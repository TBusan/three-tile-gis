...
`)+`
`+m);const v=x+p+a,M=x+m+o,L=vl(s,s.VERTEX_SHADER,v),b=vl(s,s.FRAGMENT_SHADER,M);s.attachShader(g,L),s.attachShader(g,b),e.index0AttributeName!==void 0?s.bindAttribLocation(g,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(g,0,"position"),s.linkProgram(g);function T(R){if(n.debug.checkShaderErrors){const k=s.getProgramInfoLog(g).trim(),F=s.getShaderInfoLog(L).trim(),H=s.getShaderInfoLog(b).trim();let Z=!0,W=!0;if(s.getProgramParameter(g,s.LINK_STATUS)===!1)if(Z=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,g,L,b);else{const Q=Ml(s,L,"vertex"),V=Ml(s,b,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(g,s.VALIDATE_STATUS)+`
...
}`;function Z_(n,t,e){let i=new kc;const s=new ct,r=new ct,a=new Ee,o=new Y_({depthPacking:Pf}),h=new $_,l={},c=e.maxTextureSize,f={[gn]:Ve,[Ve]:gn,[An]:An},d=new Yn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ct},radius:{value:4}},vertexShader:K_,fragmentShader:j_}),u=d.clone();u.defines.HORIZONTAL_PASS=1;const _=new Le;_.setAttribute("position",new ve(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const g=new ke(_,d),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=gc;let m=this.type;this.render=function(b,T,C){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||b.length===0)return;const E=n.getRenderTarget(),S=n.getActiveCubeFace(),R=n.getActiveMipmapLevel(),k=n.state;k.setBlending(Xn),k.buffers.color.setClear(1,1,1,1),k.buffers.depth.setTest(!0),k.setScissorTest(!1);const F=m!==Tn&&this.type===Tn,H=m===Tn&&this.type!==Tn;for(let Z=0,W=b.length;Z<W;Z++){const Q=b[Z],V=Q.shadow;if(V===void 0){console.warn("THREE.WebGLShadowMap:",Q,"has no shadow.");continue}if(V.autoUpdate===!1&&V.needsUpdate===!1)continue;s.copy(V.mapSize);const ut=V.getFrameExtents();if(s.multiply(ut),r.copy(V.mapSize),(s.x>c||s.y>c)&&(s.x>c&&(r.x=Math.floor(c/ut.x),s.x=r.x*ut.x,V.mapSize.x=r.x),s.y>c&&(r.y=Math.floor(c/ut.y),s.y=r.y*ut.y,V.mapSize.y=r.y)),V.map===null||F===!0||H===!0){const xt=this.type!==Tn?{minFilter:sn,magFilter:sn}:{};V.map!==null&&V.map.dispose(),V.map=new di(s.x,s.y,xt),V.map.texture.name=Q.name+".shadowMap",V.camera.updateProjectionMatrix()}n.setRenderTarget(V.map),n.clear();const mt=V.getViewportCount();for(let xt=0;xt<mt;xt++){const Bt=V.getViewport(xt);a.set(r.x*Bt.x,r.y*Bt.y,r.x*Bt.z,r.y*Bt.w),k.viewport(a),V.updateMatrices(Q,xt),i=V.getFrustum(),M(T,C,V.camera,Q,this.type)}V.isPointLightShadow!==!0&&this.type===Tn&&x(V,C),V.needsUpdate=!1}m=this.type,p.needsUpdate=!1,n.setRenderTarget(E,S,R)};function x(b,T){const C=t.update(g);d.defines.VSM_SAMPLES!==b.blurSamples&&(d.defines.VSM_SAMPLES=b.blurSamples,u.defines.VSM_SAMPLES=b.blurSamples,d.needsUpdate=!0,u.needsUpdate=!0),b.mapPass===null&&(b.mapPass=new di(s.x,s.y)),d.uniforms.shadow_pass.value=b.map.texture,d.uniforms.resolution.value=b.mapSize,d.uniforms.radius.value=b.radius,n.setRenderTarget(b.mapPass),n.clear(),n.renderBufferDirect(T,null,C,d,g,null),u.uniforms.shadow_pass.value=b.mapPass.texture,u.uniforms.resolution.value=b.mapSize,u.uniforms.radius.value=b.radius,n.setRenderTarget(b.map),n.clear(),n.renderBufferDirect(T,null,C,u,g,null)}function v(b,T,C,E){let S=null;const R=C.isPointLight===!0?b.customDistanceMaterial:b.customDepthMaterial;if(R!==void 0)S=R;else if(S=C.isPointLight===!0?h:o,n.localClippingEnabled&&T.clipShadows===!0&&Array.isArray(T.clippingPlanes)&&T.clippingPlanes.length!==0||T.displacementMap&&T.displacementScale!==0||T.alphaMap&&T.alphaTest>0||T.map&&T.alphaTest>0){const k=S.uuid,F=T.uuid;let H=l[k];H===void 0&&(H={},l[k]=H);let Z=H[F];Z===void 0&&(Z=S.clone(),H[F]=Z,T.addEventListener("dispose",L)),S=Z}if(S.visible=T.visible,S.wireframe=T.wireframe,E===Tn?S.side=T.shadowSide!==null?T.shadowSide:T.side:S.side=T.shadowSide!==null?T.shadowSide:f[T.side],S.alphaMap=T.alphaMap,S.alphaTest=T.alphaTest,S.map=T.map,S.clipShadows=T.clipShadows,S.clippingPlanes=T.clippingPlanes,S.clipIntersection=T.clipIntersection,S.displacementMap=T.displacementMap,S.displacementScale=T.displacementScale,S.displacementBias=T.displacementBias,S.wireframeLinewidth=T.wireframeLinewidth,S.linewidth=T.linewidth,C.isPointLight===!0&&S.isMeshDistanceMaterial===!0){const k=n.properties.get(S);k.light=C}return S}function M(b,T,C,E,S){if(b.visible===!1)return;if(b.layers.test(T.layers)&&(b.isMesh||b.isLine||b.isPoints)&&(b.castShadow||b.receiveShadow&&S===Tn)&&(!b.frustumCulled||i.intersectsObject(b))){b.modelViewMatrix.multiplyMatrices(C.matrixWorldInverse,b.matrixWorld);const F=t.update(b),H=b.material;if(Array.isArray(H)){const Z=F.groups;for(let W=0,Q=Z.length;W<Q;W++){const V=Z[W],ut=H[V.materialIndex];if(ut&&ut.visible){const mt=v(b,ut,E,S);b.onBeforeShadow(n,b,T,C,F,mt,V),n.renderBufferDirect(C,null,F,mt,b,V),b.onAfterShadow(n,b,T,C,F,mt,V)}}}else if(H.visible){const Z=v(b,H,E,S);b.onBeforeShadow(n,b,T,C,F,Z,null),n.renderBufferDirect(C,null,F,Z,b,null),b.onAfterShadow(n,b,T,C,F,Z,null)}}const k=b.children;for(let F=0,H=k.length;F<H;F++)M(k[F],T,C,E,S)}function L(b){b.target.removeEventListener("dispose",L);for(const C in l){const E=l[C],S=b.target.uuid;S in E&&(E[S].dispose(),delete E[S])}}}function J_(n){function t(){let D=!1;const nt=new Ee;let q=null;const Y=new Ee(0,0,0,0);return{setMask:function(rt){q!==rt&&!D&&(n.colorMask(rt,rt,rt,rt),q=rt)},setLocked:function(rt){D=rt},setClear:function(rt,bt,kt,pe,we){we===!0&&(rt*=pe,bt*=pe,kt*=pe),nt.set(rt,bt,kt,pe),Y.equals(nt)===!1&&(n.clearColor(rt,bt,kt,pe),Y.copy(nt))},reset:function(){D=!1,q=null,Y.set(-1,0,0,0)}}}function e(){let D=!1,nt=null,q=null,Y=null;return{setTest:function(rt){rt?Mt(n.DEPTH_TEST):dt(n.DEPTH_TEST)},setMask:function(rt){nt!==rt&&!D&&(n.depthMask(rt),nt=rt)},setFunc:function(rt){if(q!==rt){switch(rt){case cf:n.depthFunc(n.NEVER);break;case uf:n.depthFunc(n.ALWAYS);break;case ff:n.depthFunc(n.LESS);break;case Wr:n.depthFunc(n.LEQUAL);break;case df:n.depthFunc(n.EQUAL);break;case pf:n.depthFunc(n.GEQUAL);break;case mf:n.depthFunc(n.GREATER);break;case _f:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}q=rt}},setLocked:function(rt){D=rt},setClear:function(rt){Y!==rt&&(n.clearDepth(rt),Y=rt)},reset:function(){D=!1,nt=null,q=null,Y=null}}}function i(){let D=!1,nt=null,q=null,Y=null,rt=null,bt=null,kt=null,pe=null,we=null;return{setTest:function(Ht){D||(Ht?Mt(n.STENCIL_TEST):dt(n.STENCIL_TEST))},setMask:function(Ht){nt!==Ht&&!D&&(n.stencilMask(Ht),nt=Ht)},setFunc:function(Ht,xn,dn){(q!==Ht||Y!==xn||rt!==dn)&&(n.stencilFunc(Ht,xn,dn),q=Ht,Y=xn,rt=dn)},setOp:function(Ht,xn,dn){(bt!==Ht||kt!==xn||pe!==dn)&&(n.stencilOp(Ht,xn,dn),bt=Ht,kt=xn,pe=dn)},setLocked:function(Ht){D=Ht},setClear:function(Ht){we!==Ht&&(n.clearStencil(Ht),we=Ht)},reset:function(){D=!1,nt=null,q=null,Y=null,rt=null,bt=null,kt=null,pe=null,we=null}}}const s=new t,r=new e,a=new i,o=new WeakMap,h=new WeakMap;let l={},c={},f=new WeakMap,d=[],u=null,_=!1,g=null,p=null,m=null,x=null,v=null,M=null,L=null,b=new Kt(0,0,0),T=0,C=!1,E=null,S=null,R=null,k=null,F=null;const H=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let Z=!1,W=0;const Q=n.getParameter(n.VERSION);Q.indexOf("WebGL")!==-1?(W=parseFloat(/^WebGL (\d)/.exec(Q)[1]),Z=W>=1):Q.indexOf("OpenGL ES")!==-1&&(W=parseFloat(/^OpenGL ES (\d)/.exec(Q)[1]),Z=W>=2);let V=null,ut={};const mt=n.getParameter(n.SCISSOR_BOX),xt=n.getParameter(n.VIEWPORT),Bt=new Ee().fromArray(mt),Jt=new Ee().fromArray(xt);function X(D,nt,q,Y){const rt=new Uint8Array(4),bt=n.createTexture();n.bindTexture(D,bt),n.texParameteri(D,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(D,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let kt=0;kt<q;kt++)D===n.TEXTURE_3D||D===n.TEXTURE_2D_ARRAY?n.texImage3D(nt,0,n.RGBA,1,1,Y,0,n.RGBA,n.UNSIGNED_BYTE,rt):n.texImage2D(nt+kt,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,rt);return bt}const tt={};tt[n.TEXTURE_2D]=X(n.TEXTURE_2D,n.TEXTURE_2D,1),tt[n.TEXTURE_CUBE_MAP]=X(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),tt[n.TEXTURE_2D_ARRAY]=X(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),tt[n.TEXTURE_3D]=X(n.TEXTURE_3D,n.TEXTURE_3D,1,1),s.setClear(0,0,0,1),r.setClear(1),a.setClear(0),Mt(n.DEPTH_TEST),r.setFunc(Wr),Qt(!1),Et(Lh),Mt(n.CULL_FACE),fe(Xn);function Mt(D){l[D]!==!0&&(n.enable(D),l[D]=!0)}function dt(D){l[D]!==!1&&(n.disable(D),l[D]=!1)}function At(D,nt){return c[D]!==nt?(n.bindFramebuffer(D,nt),c[D]=nt,D===n.DRAW_FRAMEBUFFER&&(c[n.FRAMEBUFFER]=nt),D===n.FRAMEBUFFER&&(c[n.DRAW_FRAMEBUFFER]=nt),!0):!1}function It(D,nt){let q=d,Y=!1;if(D){q=f.get(nt),q===void 0&&(q=[],f.set(nt,q));const rt=D.textures;if(q.length!==rt.length||q[0]!==n.COLOR_ATTACHMENT0){for(let bt=0,kt=rt.length;bt<kt;bt++)q[bt]=n.COLOR_ATTACHMENT0+bt;q.length=rt.length,Y=!0}}else q[0]!==n.BACK&&(q[0]=n.BACK,Y=!0);Y&&n.drawBuffers(q)}function Gt(D){return u!==D?(n.useProgram(D),u=D,!0):!1}const ae={[hi]:n.FUNC_ADD,[qu]:n.FUNC_SUBTRACT,[Yu]:n.FUNC_REVERSE_SUBTRACT};ae[$u]=n.MIN,ae[Ku]=n.MAX;const P={[ju]:n.ZERO,[Zu]:n.ONE,[Ju]:n.SRC_COLOR,[so]:n.SRC_ALPHA,[rf]:n.SRC_ALPHA_SATURATE,[nf]:n.DST_COLOR,[tf]:n.DST_ALPHA,[Qu]:n.ONE_MINUS_SRC_COLOR,[ro]:n.ONE_MINUS_SRC_ALPHA,[sf]:n.ONE_MINUS_DST_COLOR,[ef]:n.ONE_MINUS_DST_ALPHA,[af]:n.CONSTANT_COLOR,[of]:n.ONE_MINUS_CONSTANT_COLOR,[hf]:n.CONSTANT_ALPHA,[lf]:n.ONE_MINUS_CONSTANT_ALPHA};function fe(D,nt,q,Y,rt,bt,kt,pe,we,Ht){if(D===Xn){_===!0&&(dt(n.BLEND),_=!1);return}if(_===!1&&(Mt(n.BLEND),_=!0),D!==Xu){if(D!==g||Ht!==C){if((p!==hi||v!==hi)&&(n.blendEquation(n.FUNC_ADD),p=hi,v=hi),Ht)switch(D){case $i:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Ih:n.blendFunc(n.ONE,n.ONE);break;case Nh:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Dh:n.blendFuncSeparate(n.ZERO,n.SRC_COLOR,n.ZERO,n.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}else switch(D){case $i:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Ih:n.blendFunc(n.SRC_ALPHA,n.ONE);break;case Nh:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Dh:n.blendFunc(n.ZERO,n.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}m=null,x=null,M=null,L=null,b.set(0,0,0),T=0,g=D,C=Ht}return}rt=rt||nt,bt=bt||q,kt=kt||Y,(nt!==p||rt!==v)&&(n.blendEquationSeparate(ae[nt],ae[rt]),p=nt,v=rt),(q!==m||Y!==x||bt!==M||kt!==L)&&(n.blendFuncSeparate(P[q],P[Y],P[bt],P[kt]),m=q,x=Y,M=bt,L=kt),(pe.equals(b)===!1||we!==T)&&(n.blendColor(pe.r,pe.g,pe.b,we),b.copy(pe),T=we),g=D,C=!1}function jt(D,nt){D.side===An?dt(n.CULL_FACE):Mt(n.CULL_FACE);let q=D.side===Ve;nt&&(q=!q),Qt(q),D.blending===$i&&D.transparent===!1?fe(Xn):fe(D.blending,D.blendEquation,D.blendSrc,D.blendDst,D.blendEquationAlpha,D.blendSrcAlpha,D.blendDstAlpha,D.blendColor,D.blendAlpha,D.premultipliedAlpha),r.setFunc(D.depthFunc),r.setTest(D.depthTest),r.setMask(D.depthWrite),s.setMask(D.colorWrite);const Y=D.stencilWrite;a.setTest(Y),Y&&(a.setMask(D.stencilWriteMask),a.setFunc(D.stencilFunc,D.stencilRef,D.stencilFuncMask),a.setOp(D.stencilFail,D.stencilZFail,D.stencilZPass)),Ct(D.polygonOffset,D.polygonOffsetFactor,D.polygonOffsetUnits),D.alphaToCoverage===!0?Mt(n.SAMPLE_ALPHA_TO_COVERAGE):dt(n.SAMPLE_ALPHA_TO_COVERAGE)}function Qt(D){E!==D&&(D?n.frontFace(n.CW):n.frontFace(n.CCW),E=D)}function Et(D){D!==Hu?(Mt(n.CULL_FACE),D!==S&&(D===Lh?n.cullFace(n.BACK):D===Vu?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):dt(n.CULL_FACE),S=D}function de(D){D!==R&&(Z&&n.lineWidth(D),R=D)}function Ct(D,nt,q){D?(Mt(n.POLYGON_OFFSET_FILL),(k!==nt||F!==q)&&(n.polygonOffset(nt,q),k=nt,F=q)):dt(n.POLYGON_OFFSET_FILL)}function Nt(D){D?Mt(n.SCISSOR_TEST):dt(n.SCISSOR_TEST)}function A(D){D===void 0&&(D=n.TEXTURE0+H-1),V!==D&&(n.activeTexture(D),V=D)}function y(D,nt,q){q===void 0&&(V===null?q=n.TEXTURE0+H-1:q=V);let Y=ut[q];Y===void 0&&(Y={type:void 0,texture:void 0},ut[q]=Y),(Y.type!==D||Y.texture!==nt)&&(V!==q&&(n.activeTexture(q),V=q),n.bindTexture(D,nt||tt[D]),Y.type=D,Y.texture=nt)}function z(){const D=ut[V];D!==void 0&&D.type!==void 0&&(n.bindTexture(D.type,null),D.type=void 0,D.texture=void 0)}function $(){try{n.compressedTexImage2D.apply(n,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function J(){try{n.compressedTexImage3D.apply(n,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function K(){try{n.texSubImage2D.apply(n,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function wt(){try{n.texSubImage3D.apply(n,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function ht(){try{n.compressedTexSubImage2D.apply(n,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function pt(){try{n.compressedTexSubImage3D.apply(n,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Dt(){try{n.texStorage2D.apply(n,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function et(){try{n.texStorage3D.apply(n,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function ft(){try{n.texImage2D.apply(n,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function zt(){try{n.texImage3D.apply(n,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Rt(D){Bt.equals(D)===!1&&(n.scissor(D.x,D.y,D.z,D.w),Bt.copy(D))}function _t(D){Jt.equals(D)===!1&&(n.viewport(D.x,D.y,D.z,D.w),Jt.copy(D))}function Lt(D,nt){let q=h.get(nt);q===void 0&&(q=new WeakMap,h.set(nt,q));let Y=q.get(D);Y===void 0&&(Y=n.getUniformBlockIndex(nt,D.name),q.set(D,Y))}function Ft(D,nt){const Y=h.get(nt).get(D);o.get(nt)!==Y&&(n.uniformBlockBinding(nt,Y,D.__bindingPointIndex),o.set(nt,Y))}function ie(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),l={},V=null,ut={},c={},f=new WeakMap,d=[],u=null,_=!1,g=null,p=null,m=null,x=null,v=null,M=null,L=null,b=new Kt(0,0,0),T=0,C=!1,E=null,S=null,R=null,k=null,F=null,Bt.set(0,0,n.canvas.width,n.canvas.height),Jt.set(0,0,n.canvas.width,n.canvas.height),s.reset(),r.reset(),a.reset()}return{buffers:{color:s,depth:r,stencil:a},enable:Mt,disable:dt,bindFramebuffer:At,drawBuffers:It,useProgram:Gt,setBlending:fe,setMaterial:jt,setFlipSided:Qt,setCullFace:Et,setLineWidth:de,setPolygonOffset:Ct,setScissorTest:Nt,activeTexture:A,bindTexture:y,unbindTexture:z,compressedTexImage2D:$,compressedTexImage3D:J,texImage2D:ft,texImage3D:zt,updateUBOMapping:Lt,uniformBlockBinding:Ft,texStorage2D:Dt,texStorage3D:et,texSubImage2D:K,texSubImage3D:wt,compressedTexSubImage2D:ht,compressedTexSubImage3D:pt,scissor:Rt,viewport:_t,reset:ie}}function Al(n,t,e,i){const s=Q_(i);switch(e){case Ec:return n*t;case bc:return n*t;case Tc:return n*t*2;case Ac:return n*t/s.components*s.byteLength;case nh:return n*t/s.components*s.byteLength;case Pc:return n*t*2/s.components*s.byteLength;case ih:return n*t*2/s.components*s.byteLength;case wc:return n*t*3/s.components*s.byteLength;case un:return n*t*4/s.components*s.byteLength;case sh:return n*t*4/s.components*s.byteLength;case Dr:case Ur:return Math.floor((n+3)/4)*Math.floor((t+3)/4)*8;case Or:case Fr:return Math.floor((n+3)/4)*Math.floor((t+3)/4)*16;case uo:case po:return Math.max(n,16)*Math.max(t,8)/4;case co:case fo:return Math.max(n,8)*Math.max(t,8)/2;case mo:case _o:return Math.floor((n+3)/4)*Math.floor((t+3)/4)*8;case go:return Math.floor((n+3)/4)*Math.floor((t+3)/4)*16;case vo:return Math.floor((n+3)/4)*Math.floor((t+3)/4)*16;case Mo:return Math.floor((n+4)/5)*Math.floor((t+3)/4)*16;case xo:return Math.floor((n+4)/5)*Math.floor((t+4)/5)*16;case yo:return Math.floor((n+5)/6)*Math.floor((t+4)/5)*16;case So:return Math.floor((n+5)/6)*Math.floor((t+5)/6)*16;case Eo:return Math.floor((n+7)/8)*Math.floor((t+4)/5)*16;case wo:return Math.floor((n+7)/8)*Math.floor((t+5)/6)*16;case bo:return Math.floor((n+7)/8)*Math.floor((t+7)/8)*16;case To:return Math.floor((n+9)/10)*Math.floor((t+4)/5)*16;case Ao:return Math.floor((n+9)/10)*Math.floor((t+5)/6)*16;case Po:return Math.floor((n+9)/10)*Math.floor((t+7)/8)*16;case Ro:return Math.floor((n+9)/10)*Math.floor((t+9)/10)*16;case Co:return Math.floor((n+11)/12)*Math.floor((t+9)/10)*16;case Lo:return Math.floor((n+11)/12)*Math.floor((t+11)/12)*16;case Gr:case Io:case No:return Math.ceil(n/4)*Math.ceil(t/4)*16;case Rc:case Do:return Math.ceil(n/4)*Math.ceil(t/4)*8;case Uo:case Oo:return Math.ceil(n/4)*Math.ceil(t/4)*16}throw new Error(`Unable to determine texture byte length for ${e} format.`)}function Q_(n){switch(n){case Ln:case xc:return{byteLength:1,components:1};case Ns:case yc:case Vs:return{byteLength:2,components:1};case th:case eh:return{byteLength:2,components:4};case fi:case Qo:case Pn:return{byteLength:4,components:1};case Sc:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${n}.`)}function tg(n,t,e,i,s,r,a){const o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,h=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new ct,c=new WeakMap;let f;const d=new WeakMap;let u=!1;try{u=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(A,y){return u?new OffscreenCanvas(A,y):Kr("canvas")}function g(A,y,z){let $=1;const J=Nt(A);if((J.width>z||J.height>z)&&($=z/Math.max(J.width,J.height)),$<1)if(typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&A instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&A instanceof ImageBitmap||typeof VideoFrame<"u"&&A instanceof VideoFrame){const K=Math.floor($*J.width),wt=Math.floor($*J.height);f===void 0&&(f=_(K,wt));const ht=y?_(K,wt):f;return ht.width=K,ht.height=wt,ht.getContext("2d").drawImage(A,0,0,K,wt),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+J.width+"x"+J.height+") to ("+K+"x"+wt+")."),ht}else return"data"in A&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+J.width+"x"+J.height+")."),A;return A}function p(A){return A.generateMipmaps&&A.minFilter!==sn&&A.minFilter!==Ze}function m(A){n.generateMipmap(A)}function x(A,y,z,$,J=!1){if(A!==null){if(n[A]!==void 0)return n[A];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+A+"'")}let K=y;if(y===n.RED&&(z===n.FLOAT&&(K=n.R32F),z===n.HALF_FLOAT&&(K=n.R16F),z===n.UNSIGNED_BYTE&&(K=n.R8)),y===n.RED_INTEGER&&(z===n.UNSIGNED_BYTE&&(K=n.R8UI),z===n.UNSIGNED_SHORT&&(K=n.R16UI),z===n.UNSIGNED_INT&&(K=n.R32UI),z===n.BYTE&&(K=n.R8I),z===n.SHORT&&(K=n.R16I),z===n.INT&&(K=n.R32I)),y===n.RG&&(z===n.FLOAT&&(K=n.RG32F),z===n.HALF_FLOAT&&(K=n.RG16F),z===n.UNSIGNED_BYTE&&(K=n.RG8)),y===n.RG_INTEGER&&(z===n.UNSIGNED_BYTE&&(K=n.RG8UI),z===n.UNSIGNED_SHORT&&(K=n.RG16UI),z===n.UNSIGNED_INT&&(K=n.RG32UI),z===n.BYTE&&(K=n.RG8I),z===n.SHORT&&(K=n.RG16I),z===n.INT&&(K=n.RG32I)),y===n.RGB&&z===n.UNSIGNED_INT_5_9_9_9_REV&&(K=n.RGB9_E5),y===n.RGBA){const wt=J?Xr:$t.getTransfer($);z===n.FLOAT&&(K=n.RGBA32F),z===n.HALF_FLOAT&&(K=n.RGBA16F),z===n.UNSIGNED_BYTE&&(K=wt===ee?n.SRGB8_ALPHA8:n.RGBA8),z===n.UNSIGNED_SHORT_4_4_4_4&&(K=n.RGBA4),z===n.UNSIGNED_SHORT_5_5_5_1&&(K=n.RGB5_A1)}return(K===n.R16F||K===n.R32F||K===n.RG16F||K===n.RG32F||K===n.RGBA16F||K===n.RGBA32F)&&t.get("EXT_color_buffer_float"),K}function v(A,y){let z;return A?y===null||y===fi||y===ns?z=n.DEPTH24_STENCIL8:y===Pn?z=n.DEPTH32F_STENCIL8:y===Ns&&(z=n.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):y===null||y===fi||y===ns?z=n.DEPTH_COMPONENT24:y===Pn?z=n.DEPTH_COMPONENT32F:y===Ns&&(z=n.DEPTH_COMPONENT16),z}function M(A,y){return p(A)===!0||A.isFramebufferTexture&&A.minFilter!==sn&&A.minFilter!==Ze?Math.log2(Math.max(y.width,y.height))+1:A.mipmaps!==void 0&&A.mipmaps.length>0?A.mipmaps.length:A.isCompressedTexture&&Array.isArray(A.image)?y.mipmaps.length:1}function L(A){const y=A.target;y.removeEventListener("dispose",L),T(y),y.isVideoTexture&&c.delete(y)}function b(A){const y=A.target;y.removeEventListener("dispose",b),E(y)}function T(A){const y=i.get(A);if(y.__webglInit===void 0)return;const z=A.source,$=d.get(z);if($){const J=$[y.__cacheKey];J.usedTimes--,J.usedTimes===0&&C(A),Object.keys($).length===0&&d.delete(z)}i.remove(A)}function C(A){const y=i.get(A);n.deleteTexture(y.__webglTexture);const z=A.source,$=d.get(z);delete $[y.__cacheKey],a.memory.textures--}function E(A){const y=i.get(A);if(A.depthTexture&&A.depthTexture.dispose(),A.isWebGLCubeRenderTarget)for(let $=0;$<6;$++){if(Array.isArray(y.__webglFramebuffer[$]))for(let J=0;J<y.__webglFramebuffer[$].length;J++)n.deleteFramebuffer(y.__webglFramebuffer[$][J]);else n.deleteFramebuffer(y.__webglFramebuffer[$]);y.__webglDepthbuffer&&n.deleteRenderbuffer(y.__webglDepthbuffer[$])}else{if(Array.isArray(y.__webglFramebuffer))for(let $=0;$<y.__webglFramebuffer.length;$++)n.deleteFramebuffer(y.__webglFramebuffer[$]);else n.deleteFramebuffer(y.__webglFramebuffer);if(y.__webglDepthbuffer&&n.deleteRenderbuffer(y.__webglDepthbuffer),y.__webglMultisampledFramebuffer&&n.deleteFramebuffer(y.__webglMultisampledFramebuffer),y.__webglColorRenderbuffer)for(let $=0;$<y.__webglColorRenderbuffer.length;$++)y.__webglColorRenderbuffer[$]&&n.deleteRenderbuffer(y.__webglColorRenderbuffer[$]);y.__webglDepthRenderbuffer&&n.deleteRenderbuffer(y.__webglDepthRenderbuffer)}const z=A.textures;for(let $=0,J=z.length;$<J;$++){const K=i.get(z[$]);K.__webglTexture&&(n.deleteTexture(K.__webglTexture),a.memory.textures--),i.remove(z[$])}i.remove(A)}let S=0;function R(){S=0}function k(){const A=S;return A>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+A+" texture units while this GPU supports only "+s.maxTextures),S+=1,A}function F(A){const y=[];return y.push(A.wrapS),y.push(A.wrapT),y.push(A.wrapR||0),y.push(A.magFilter),y.push(A.minFilter),y.push(A.anisotropy),y.push(A.internalFormat),y.push(A.format),y.push(A.type),y.push(A.generateMipmaps),y.push(A.premultiplyAlpha),y.push(A.flipY),y.push(A.unpackAlignment),y.push(A.colorSpace),y.join()}function H(A,y){const z=i.get(A);if(A.isVideoTexture&&de(A),A.isRenderTargetTexture===!1&&A.version>0&&z.__version!==A.version){const $=A.image;if($===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if($.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Jt(z,A,y);return}}e.bindTexture(n.TEXTURE_2D,z.__webglTexture,n.TEXTURE0+y)}function Z(A,y){const z=i.get(A);if(A.version>0&&z.__version!==A.version){Jt(z,A,y);return}e.bindTexture(n.TEXTURE_2D_ARRAY,z.__webglTexture,n.TEXTURE0+y)}function W(A,y){const z=i.get(A);if(A.version>0&&z.__version!==A.version){Jt(z,A,y);return}e.bindTexture(n.TEXTURE_3D,z.__webglTexture,n.TEXTURE0+y)}function Q(A,y){const z=i.get(A);if(A.version>0&&z.__version!==A.version){X(z,A,y);return}e.bindTexture(n.TEXTURE_CUBE_MAP,z.__webglTexture,n.TEXTURE0+y)}const V={[ho]:n.REPEAT,[ci]:n.CLAMP_TO_EDGE,[lo]:n.MIRRORED_REPEAT},ut={[sn]:n.NEAREST,[Tf]:n.NEAREST_MIPMAP_NEAREST,[tr]:n.NEAREST_MIPMAP_LINEAR,[Ze]:n.LINEAR,[Ea]:n.LINEAR_MIPMAP_NEAREST,[Vn]:n.LINEAR_MIPMAP_LINEAR},mt={[Lf]:n.NEVER,[Ff]:n.ALWAYS,[If]:n.LESS,[Cc]:n.LEQUAL,[Nf]:n.EQUAL,[Of]:n.GEQUAL,[Df]:n.GREATER,[Uf]:n.NOTEQUAL};function xt(A,y){if(y.type===Pn&&t.has("OES_texture_float_linear")===!1&&(y.magFilter===Ze||y.magFilter===Ea||y.magFilter===tr||y.magFilter===Vn||y.minFilter===Ze||y.minFilter===Ea||y.minFilter===tr||y.minFilter===Vn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(A,n.TEXTURE_WRAP_S,V[y.wrapS]),n.texParameteri(A,n.TEXTURE_WRAP_T,V[y.wrapT]),(A===n.TEXTURE_3D||A===n.TEXTURE_2D_ARRAY)&&n.texParameteri(A,n.TEXTURE_WRAP_R,V[y.wrapR]),n.texParameteri(A,n.TEXTURE_MAG_FILTER,ut[y.magFilter]),n.texParameteri(A,n.TEXTURE_MIN_FILTER,ut[y.minFilter]),y.compareFunction&&(n.texParameteri(A,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(A,n.TEXTURE_COMPARE_FUNC,mt[y.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(y.magFilter===sn||y.minFilter!==tr&&y.minFilter!==Vn||y.type===Pn&&t.has("OES_texture_float_linear")===!1)return;if(y.anisotropy>1||i.get(y).__currentAnisotropy){const z=t.get("EXT_texture_filter_anisotropic");n.texParameterf(A,z.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(y.anisotropy,s.getMaxAnisotropy())),i.get(y).__currentAnisotropy=y.anisotropy}}}function Bt(A,y){let z=!1;A.__webglInit===void 0&&(A.__webglInit=!0,y.addEventListener("dispose",L));const $=y.source;let J=d.get($);J===void 0&&(J={},d.set($,J));const K=F(y);if(K!==A.__cacheKey){J[K]===void 0&&(J[K]={texture:n.createTexture(),usedTimes:0},a.memory.textures++,z=!0),J[K].usedTimes++;const wt=J[A.__cacheKey];wt!==void 0&&(J[A.__cacheKey].usedTimes--,wt.usedTimes===0&&C(y)),A.__cacheKey=K,A.__webglTexture=J[K].texture}return z}function Jt(A,y,z){let $=n.TEXTURE_2D;(y.isDataArrayTexture||y.isCompressedArrayTexture)&&($=n.TEXTURE_2D_ARRAY),y.isData3DTexture&&($=n.TEXTURE_3D);const J=Bt(A,y),K=y.source;e.bindTexture($,A.__webglTexture,n.TEXTURE0+z);const wt=i.get(K);if(K.version!==wt.__version||J===!0){e.activeTexture(n.TEXTURE0+z);const ht=$t.getPrimaries($t.workingColorSpace),pt=y.colorSpace===Hn?null:$t.getPrimaries(y.colorSpace),Dt=y.colorSpace===Hn||ht===pt?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,y.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,y.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,y.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Dt);let et=g(y.image,!1,s.maxTextureSize);et=Ct(y,et);const ft=r.convert(y.format,y.colorSpace),zt=r.convert(y.type);let Rt=x(y.internalFormat,ft,zt,y.colorSpace,y.isVideoTexture);xt($,y);let _t;const Lt=y.mipmaps,Ft=y.isVideoTexture!==!0,ie=wt.__version===void 0||J===!0,D=K.dataReady,nt=M(y,et);if(y.isDepthTexture)Rt=v(y.format===is,y.type),ie&&(Ft?e.texStorage2D(n.TEXTURE_2D,1,Rt,et.width,et.height):e.texImage2D(n.TEXTURE_2D,0,Rt,et.width,et.height,0,ft,zt,null));else if(y.isDataTexture)if(Lt.length>0){Ft&&ie&&e.texStorage2D(n.TEXTURE_2D,nt,Rt,Lt[0].width,Lt[0].height);for(let q=0,Y=Lt.length;q<Y;q++)_t=Lt[q],Ft?D&&e.texSubImage2D(n.TEXTURE_2D,q,0,0,_t.width,_t.height,ft,zt,_t.data):e.texImage2D(n.TEXTURE_2D,q,Rt,_t.width,_t.height,0,ft,zt,_t.data);y.generateMipmaps=!1}else Ft?(ie&&e.texStorage2D(n.TEXTURE_2D,nt,Rt,et.width,et.height),D&&e.texSubImage2D(n.TEXTURE_2D,0,0,0,et.width,et.height,ft,zt,et.data)):e.texImage2D(n.TEXTURE_2D,0,Rt,et.width,et.height,0,ft,zt,et.data);else if(y.isCompressedTexture)if(y.isCompressedArrayTexture){Ft&&ie&&e.texStorage3D(n.TEXTURE_2D_ARRAY,nt,Rt,Lt[0].width,Lt[0].height,et.depth);for(let q=0,Y=Lt.length;q<Y;q++)if(_t=Lt[q],y.format!==un)if(ft!==null)if(Ft){if(D)if(y.layerUpdates.size>0){const rt=Al(_t.width,_t.height,y.format,y.type);for(const bt of y.layerUpdates){const kt=_t.data.subarray(bt*rt/_t.data.BYTES_PER_ELEMENT,(bt+1)*rt/_t.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,q,0,0,bt,_t.width,_t.height,1,ft,kt,0,0)}y.clearLayerUpdates()}else e.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,q,0,0,0,_t.width,_t.height,et.depth,ft,_t.data,0,0)}else e.compressedTexImage3D(n.TEXTURE_2D_ARRAY,q,Rt,_t.width,_t.height,et.depth,0,_t.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ft?D&&e.texSubImage3D(n.TEXTURE_2D_ARRAY,q,0,0,0,_t.width,_t.height,et.depth,ft,zt,_t.data):e.texImage3D(n.TEXTURE_2D_ARRAY,q,Rt,_t.width,_t.height,et.depth,0,ft,zt,_t.data)}else{Ft&&ie&&e.texStorage2D(n.TEXTURE_2D,nt,Rt,Lt[0].width,Lt[0].height);for(let q=0,Y=Lt.length;q<Y;q++)_t=Lt[q],y.format!==un?ft!==null?Ft?D&&e.compressedTexSubImage2D(n.TEXTURE_2D,q,0,0,_t.width,_t.height,ft,_t.data):e.compressedTexImage2D(n.TEXTURE_2D,q,Rt,_t.width,_t.height,0,_t.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ft?D&&e.texSubImage2D(n.TEXTURE_2D,q,0,0,_t.width,_t.height,ft,zt,_t.data):e.texImage2D(n.TEXTURE_2D,q,Rt,_t.width,_t.height,0,ft,zt,_t.data)}else if(y.isDataArrayTexture)if(Ft){if(ie&&e.texStorage3D(n.TEXTURE_2D_ARRAY,nt,Rt,et.width,et.height,et.depth),D)if(y.layerUpdates.size>0){const q=Al(et.width,et.height,y.format,y.type);for(const Y of y.layerUpdates){const rt=et.data.subarray(Y*q/et.data.BYTES_PER_ELEMENT,(Y+1)*q/et.data.BYTES_PER_ELEMENT);e.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,Y,et.width,et.height,1,ft,zt,rt)}y.clearLayerUpdates()}else e.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,et.width,et.height,et.depth,ft,zt,et.data)}else e.texImage3D(n.TEXTURE_2D_ARRAY,0,Rt,et.width,et.height,et.depth,0,ft,zt,et.data);else if(y.isData3DTexture)Ft?(ie&&e.texStorage3D(n.TEXTURE_3D,nt,Rt,et.width,et.height,et.depth),D&&e.texSubImage3D(n.TEXTURE_3D,0,0,0,0,et.width,et.height,et.depth,ft,zt,et.data)):e.texImage3D(n.TEXTURE_3D,0,Rt,et.width,et.height,et.depth,0,ft,zt,et.data);else if(y.isFramebufferTexture){if(ie)if(Ft)e.texStorage2D(n.TEXTURE_2D,nt,Rt,et.width,et.height);else{let q=et.width,Y=et.height;for(let rt=0;rt<nt;rt++)e.texImage2D(n.TEXTURE_2D,rt,Rt,q,Y,0,ft,zt,null),q>>=1,Y>>=1}}else if(Lt.length>0){if(Ft&&ie){const q=Nt(Lt[0]);e.texStorage2D(n.TEXTURE_2D,nt,Rt,q.width,q.height)}for(let q=0,Y=Lt.length;q<Y;q++)_t=Lt[q],Ft?D&&e.texSubImage2D(n.TEXTURE_2D,q,0,0,ft,zt,_t):e.texImage2D(n.TEXTURE_2D,q,Rt,ft,zt,_t);y.generateMipmaps=!1}else if(Ft){if(ie){const q=Nt(et);e.texStorage2D(n.TEXTURE_2D,nt,Rt,q.width,q.height)}D&&e.texSubImage2D(n.TEXTURE_2D,0,0,0,ft,zt,et)}else e.texImage2D(n.TEXTURE_2D,0,Rt,ft,zt,et);p(y)&&m($),wt.__version=K.version,y.onUpdate&&y.onUpdate(y)}A.__version=y.version}function X(A,y,z){if(y.image.length!==6)return;const $=Bt(A,y),J=y.source;e.bindTexture(n.TEXTURE_CUBE_MAP,A.__webglTexture,n.TEXTURE0+z);const K=i.get(J);if(J.version!==K.__version||$===!0){e.activeTexture(n.TEXTURE0+z);const wt=$t.getPrimaries($t.workingColorSpace),ht=y.colorSpace===Hn?null:$t.getPrimaries(y.colorSpace),pt=y.colorSpace===Hn||wt===ht?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,y.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,y.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,y.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,pt);const Dt=y.isCompressedTexture||y.image[0].isCompressedTexture,et=y.image[0]&&y.image[0].isDataTexture,ft=[];for(let Y=0;Y<6;Y++)!Dt&&!et?ft[Y]=g(y.image[Y],!0,s.maxCubemapSize):ft[Y]=et?y.image[Y].image:y.image[Y],ft[Y]=Ct(y,ft[Y]);const zt=ft[0],Rt=r.convert(y.format,y.colorSpace),_t=r.convert(y.type),Lt=x(y.internalFormat,Rt,_t,y.colorSpace),Ft=y.isVideoTexture!==!0,ie=K.__version===void 0||$===!0,D=J.dataReady;let nt=M(y,zt);xt(n.TEXTURE_CUBE_MAP,y);let q;if(Dt){Ft&&ie&&e.texStorage2D(n.TEXTURE_CUBE_MAP,nt,Lt,zt.width,zt.height);for(let Y=0;Y<6;Y++){q=ft[Y].mipmaps;for(let rt=0;rt<q.length;rt++){const bt=q[rt];y.format!==un?Rt!==null?Ft?D&&e.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Y,rt,0,0,bt.width,bt.height,Rt,bt.data):e.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Y,rt,Lt,bt.width,bt.height,0,bt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Ft?D&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Y,rt,0,0,bt.width,bt.height,Rt,_t,bt.data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Y,rt,Lt,bt.width,bt.height,0,Rt,_t,bt.data)}}}else{if(q=y.mipmaps,Ft&&ie){q.length>0&&nt++;const Y=Nt(ft[0]);e.texStorage2D(n.TEXTURE_CUBE_MAP,nt,Lt,Y.width,Y.height)}for(let Y=0;Y<6;Y++)if(et){Ft?D&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Y,0,0,0,ft[Y].width,ft[Y].height,Rt,_t,ft[Y].data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Y,0,Lt,ft[Y].width,ft[Y].height,0,Rt,_t,ft[Y].data);for(let rt=0;rt<q.length;rt++){const kt=q[rt].image[Y].image;Ft?D&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Y,rt+1,0,0,kt.width,kt.height,Rt,_t,kt.data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Y,rt+1,Lt,kt.width,kt.height,0,Rt,_t,kt.data)}}else{Ft?D&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Y,0,0,0,Rt,_t,ft[Y]):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Y,0,Lt,Rt,_t,ft[Y]);for(let rt=0;rt<q.length;rt++){const bt=q[rt];Ft?D&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Y,rt+1,0,0,Rt,_t,bt.image[Y]):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Y,rt+1,Lt,Rt,_t,bt.image[Y])}}}p(y)&&m(n.TEXTURE_CUBE_MAP),K.__version=J.version,y.onUpdate&&y.onUpdate(y)}A.__version=y.version}function tt(A,y,z,$,J,K){const wt=r.convert(z.format,z.colorSpace),ht=r.convert(z.type),pt=x(z.internalFormat,wt,ht,z.colorSpace);if(!i.get(y).__hasExternalTextures){const et=Math.max(1,y.width>>K),ft=Math.max(1,y.height>>K);J===n.TEXTURE_3D||J===n.TEXTURE_2D_ARRAY?e.texImage3D(J,K,pt,et,ft,y.depth,0,wt,ht,null):e.texImage2D(J,K,pt,et,ft,0,wt,ht,null)}e.bindFramebuffer(n.FRAMEBUFFER,A),Et(y)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,$,J,i.get(z).__webglTexture,0,Qt(y)):(J===n.TEXTURE_2D||J>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&J<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,$,J,i.get(z).__webglTexture,K),e.bindFramebuffer(n.FRAMEBUFFER,null)}function Mt(A,y,z){if(n.bindRenderbuffer(n.RENDERBUFFER,A),y.depthBuffer){const $=y.depthTexture,J=$&&$.isDepthTexture?$.type:null,K=v(y.stencilBuffer,J),wt=y.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ht=Qt(y);Et(y)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,ht,K,y.width,y.height):z?n.renderbufferStorageMultisample(n.RENDERBUFFER,ht,K,y.width,y.height):n.renderbufferStorage(n.RENDERBUFFER,K,y.width,y.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,wt,n.RENDERBUFFER,A)}else{const $=y.textures;for(let J=0;J<$.length;J++){const K=$[J],wt=r.convert(K.format,K.colorSpace),ht=r.convert(K.type),pt=x(K.internalFormat,wt,ht,K.colorSpace),Dt=Qt(y);z&&Et(y)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,Dt,pt,y.width,y.height):Et(y)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,Dt,pt,y.width,y.height):n.renderbufferStorage(n.RENDERBUFFER,pt,y.width,y.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function dt(A,y){if(y&&y.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(n.FRAMEBUFFER,A),!(y.depthTexture&&y.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!i.get(y.depthTexture).__webglTexture||y.depthTexture.image.width!==y.width||y.depthTexture.image.height!==y.height)&&(y.depthTexture.image.width=y.width,y.depthTexture.image.height=y.height,y.depthTexture.needsUpdate=!0),H(y.depthTexture,0);const $=i.get(y.depthTexture).__webglTexture,J=Qt(y);if(y.depthTexture.format===Ki)Et(y)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,$,0,J):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,$,0);else if(y.depthTexture.format===is)Et(y)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,$,0,J):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,$,0);else throw new Error("Unknown depthTexture format")}function At(A){const y=i.get(A),z=A.isWebGLCubeRenderTarget===!0;if(y.__boundDepthTexture!==A.depthTexture){const $=A.depthTexture;if(y.__depthDisposeCallback&&y.__depthDisposeCallback(),$){const J=()=>{delete y.__boundDepthTexture,delete y.__depthDisposeCallback,$.removeEventListener("dispose",J)};$.addEventListener("dispose",J),y.__depthDisposeCallback=J}y.__boundDepthTexture=$}if(A.depthTexture&&!y.__autoAllocateDepthBuffer){if(z)throw new Error("target.depthTexture not supported in Cube render targets");dt(y.__webglFramebuffer,A)}else if(z){y.__webglDepthbuffer=[];for(let $=0;$<6;$++)if(e.bindFramebuffer(n.FRAMEBUFFER,y.__webglFramebuffer[$]),y.__webglDepthbuffer[$]===void 0)y.__webglDepthbuffer[$]=n.createRenderbuffer(),Mt(y.__webglDepthbuffer[$],A,!1);else{const J=A.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,K=y.__webglDepthbuffer[$];n.bindRenderbuffer(n.RENDERBUFFER,K),n.framebufferRenderbuffer(n.FRAMEBUFFER,J,n.RENDERBUFFER,K)}}else if(e.bindFramebuffer(n.FRAMEBUFFER,y.__webglFramebuffer),y.__webglDepthbuffer===void 0)y.__webglDepthbuffer=n.createRenderbuffer(),Mt(y.__webglDepthbuffer,A,!1);else{const $=A.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,J=y.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,J),n.framebufferRenderbuffer(n.FRAMEBUFFER,$,n.RENDERBUFFER,J)}e.bindFramebuffer(n.FRAMEBUFFER,null)}function It(A,y,z){const $=i.get(A);y!==void 0&&tt($.__webglFramebuffer,A,A.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),z!==void 0&&At(A)}function Gt(A){const y=A.texture,z=i.get(A),$=i.get(y);A.addEventListener("dispose",b);const J=A.textures,K=A.isWebGLCubeRenderTarget===!0,wt=J.length>1;if(wt||($.__webglTexture===void 0&&($.__webglTexture=n.createTexture()),$.__version=y.version,a.memory.textures++),K){z.__webglFramebuffer=[];for(let ht=0;ht<6;ht++)if(y.mipmaps&&y.mipmaps.length>0){z.__webglFramebuffer[ht]=[];for(let pt=0;pt<y.mipmaps.length;pt++)z.__webglFramebuffer[ht][pt]=n.createFramebuffer()}else z.__webglFramebuffer[ht]=n.createFramebuffer()}else{if(y.mipmaps&&y.mipmaps.length>0){z.__webglFramebuffer=[];for(let ht=0;ht<y.mipmaps.length;ht++)z.__webglFramebuffer[ht]=n.createFramebuffer()}else z.__webglFramebuffer=n.createFramebuffer();if(wt)for(let ht=0,pt=J.length;ht<pt;ht++){const Dt=i.get(J[ht]);Dt.__webglTexture===void 0&&(Dt.__webglTexture=n.createTexture(),a.memory.textures++)}if(A.samples>0&&Et(A)===!1){z.__webglMultisampledFramebuffer=n.createFramebuffer(),z.__webglColorRenderbuffer=[],e.bindFramebuffer(n.FRAMEBUFFER,z.__webglMultisampledFramebuffer);for(let ht=0;ht<J.length;ht++){const pt=J[ht];z.__webglColorRenderbuffer[ht]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,z.__webglColorRenderbuffer[ht]);const Dt=r.convert(pt.format,pt.colorSpace),et=r.convert(pt.type),ft=x(pt.internalFormat,Dt,et,pt.colorSpace,A.isXRRenderTarget===!0),zt=Qt(A);n.renderbufferStorageMultisample(n.RENDERBUFFER,zt,ft,A.width,A.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ht,n.RENDERBUFFER,z.__webglColorRenderbuffer[ht])}n.bindRenderbuffer(n.RENDERBUFFER,null),A.depthBuffer&&(z.__webglDepthRenderbuffer=n.createRenderbuffer(),Mt(z.__webglDepthRenderbuffer,A,!0)),e.bindFramebuffer(n.FRAMEBUFFER,null)}}if(K){e.bindTexture(n.TEXTURE_CUBE_MAP,$.__webglTexture),xt(n.TEXTURE_CUBE_MAP,y);for(let ht=0;ht<6;ht++)if(y.mipmaps&&y.mipmaps.length>0)for(let pt=0;pt<y.mipmaps.length;pt++)tt(z.__webglFramebuffer[ht][pt],A,y,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ht,pt);else tt(z.__webglFramebuffer[ht],A,y,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ht,0);p(y)&&m(n.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(wt){for(let ht=0,pt=J.length;ht<pt;ht++){const Dt=J[ht],et=i.get(Dt);e.bindTexture(n.TEXTURE_2D,et.__webglTexture),xt(n.TEXTURE_2D,Dt),tt(z.__webglFramebuffer,A,Dt,n.COLOR_ATTACHMENT0+ht,n.TEXTURE_2D,0),p(Dt)&&m(n.TEXTURE_2D)}e.unbindTexture()}else{let ht=n.TEXTURE_2D;if((A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(ht=A.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),e.bindTexture(ht,$.__webglTexture),xt(ht,y),y.mipmaps&&y.mipmaps.length>0)for(let pt=0;pt<y.mipmaps.length;pt++)tt(z.__webglFramebuffer[pt],A,y,n.COLOR_ATTACHMENT0,ht,pt);else tt(z.__webglFramebuffer,A,y,n.COLOR_ATTACHMENT0,ht,0);p(y)&&m(ht),e.unbindTexture()}A.depthBuffer&&At(A)}function ae(A){const y=A.textures;for(let z=0,$=y.length;z<$;z++){const J=y[z];if(p(J)){const K=A.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:n.TEXTURE_2D,wt=i.get(J).__webglTexture;e.bindTexture(K,wt),m(K),e.unbindTexture()}}}const P=[],fe=[];function jt(A){if(A.samples>0){if(Et(A)===!1){const y=A.textures,z=A.width,$=A.height;let J=n.COLOR_BUFFER_BIT;const K=A.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,wt=i.get(A),ht=y.length>1;if(ht)for(let pt=0;pt<y.length;pt++)e.bindFramebuffer(n.FRAMEBUFFER,wt.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+pt,n.RENDERBUFFER,null),e.bindFramebuffer(n.FRAMEBUFFER,wt.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+pt,n.TEXTURE_2D,null,0);e.bindFramebuffer(n.READ_FRAMEBUFFER,wt.__webglMultisampledFramebuffer),e.bindFramebuffer(n.DRAW_FRAMEBUFFER,wt.__webglFramebuffer);for(let pt=0;pt<y.length;pt++){if(A.resolveDepthBuffer&&(A.depthBuffer&&(J|=n.DEPTH_BUFFER_BIT),A.stencilBuffer&&A.resolveStencilBuffer&&(J|=n.STENCIL_BUFFER_BIT)),ht){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,wt.__webglColorRenderbuffer[pt]);const Dt=i.get(y[pt]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,Dt,0)}n.blitFramebuffer(0,0,z,$,0,0,z,$,J,n.NEAREST),h===!0&&(P.length=0,fe.length=0,P.push(n.COLOR_ATTACHMENT0+pt),A.depthBuffer&&A.resolveDepthBuffer===!1&&(P.push(K),fe.push(K),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,fe)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,P))}if(e.bindFramebuffer(n.READ_FRAMEBUFFER,null),e.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),ht)for(let pt=0;pt<y.length;pt++){e.bindFramebuffer(n.FRAMEBUFFER,wt.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+pt,n.RENDERBUFFER,wt.__webglColorRenderbuffer[pt]);const Dt=i.get(y[pt]).__webglTexture;e.bindFramebuffer(n.FRAMEBUFFER,wt.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+pt,n.TEXTURE_2D,Dt,0)}e.bindFramebuffer(n.DRAW_FRAMEBUFFER,wt.__webglMultisampledFramebuffer)}else if(A.depthBuffer&&A.resolveDepthBuffer===!1&&h){const y=A.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[y])}}}function Qt(A){return Math.min(s.maxSamples,A.samples)}function Et(A){const y=i.get(A);return A.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&y.__useRenderToTexture!==!1}function de(A){const y=a.render.frame;c.get(A)!==y&&(c.set(A,y),A.update())}function Ct(A,y){const z=A.colorSpace,$=A.format,J=A.type;return A.isCompressedTexture===!0||A.isVideoTexture===!0||z!==jn&&z!==Hn&&($t.getTransfer(z)===ee?($!==un||J!==Ln)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",z)),y}function Nt(A){return typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement?(l.width=A.naturalWidth||A.width,l.height=A.naturalHeight||A.height):typeof VideoFrame<"u"&&A instanceof VideoFrame?(l.width=A.displayWidth,l.height=A.displayHeight):(l.width=A.width,l.height=A.height),l}this.allocateTextureUnit=k,this.resetTextureUnits=R,this.setTexture2D=H,this.setTexture2DArray=Z,this.setTexture3D=W,this.setTextureCube=Q,this.rebindTextures=It,this.setupRenderTarget=Gt,this.updateRenderTargetMipmap=ae,this.updateMultisampleRenderTarget=jt,this.setupDepthRenderbuffer=At,this.setupFrameBufferTexture=tt,this.useMultisampledRTT=Et}function eg(n,t){function e(i,s=Hn){let r;const a=$t.getTransfer(s);if(i===Ln)return n.UNSIGNED_BYTE;if(i===th)return n.UNSIGNED_SHORT_4_4_4_4;if(i===eh)return n.UNSIGNED_SHORT_5_5_5_1;if(i===Sc)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===xc)return n.BYTE;if(i===yc)return n.SHORT;if(i===Ns)return n.UNSIGNED_SHORT;if(i===Qo)return n.INT;if(i===fi)return n.UNSIGNED_INT;if(i===Pn)return n.FLOAT;if(i===Vs)return n.HALF_FLOAT;if(i===Ec)return n.ALPHA;if(i===wc)return n.RGB;if(i===un)return n.RGBA;if(i===bc)return n.LUMINANCE;if(i===Tc)return n.LUMINANCE_ALPHA;if(i===Ki)return n.DEPTH_COMPONENT;if(i===is)return n.DEPTH_STENCIL;if(i===Ac)return n.RED;if(i===nh)return n.RED_INTEGER;if(i===Pc)return n.RG;if(i===ih)return n.RG_INTEGER;if(i===sh)return n.RGBA_INTEGER;if(i===Dr||i===Ur||i===Or||i===Fr)if(a===ee)if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(i===Dr)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===Ur)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Or)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Fr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(i===Dr)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===Ur)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Or)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Fr)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===co||i===uo||i===fo||i===po)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(i===co)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===uo)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===fo)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===po)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===mo||i===_o||i===go)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(i===mo||i===_o)return a===ee?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(i===go)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===vo||i===Mo||i===xo||i===yo||i===So||i===Eo||i===wo||i===bo||i===To||i===Ao||i===Po||i===Ro||i===Co||i===Lo)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(i===vo)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Mo)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===xo)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===yo)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===So)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Eo)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===wo)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===bo)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===To)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Ao)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Po)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Ro)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Co)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Lo)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Gr||i===Io||i===No)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(i===Gr)return a===ee?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Io)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===No)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===Rc||i===Do||i===Uo||i===Oo)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(i===Gr)return r.COMPRESSED_RED_RGTC1_EXT;if(i===Do)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Uo)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Oo)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===ns?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:e}}class ng extends nn{constructor(t=[]){super(),this.isArrayCamera=!0,this.cameras=t}}class ui extends Oe{constructor(){super(),this.isGroup=!0,this.type="Group"}}const ig={type:"move"};class $a{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new ui,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new ui,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new N,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new N),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new ui,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new N,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new N),this._grip}dispatchEvent(t){return this._targetRay!==null&&this._targetRay.dispatchEvent(t),this._grip!==null&&this._grip.dispatchEvent(t),this._hand!==null&&this._hand.dispatchEvent(t),this}connect(t){if(t&&t.hand){const e=this._hand;if(e)for(const i of t.hand.values())this._getHandJoint(e,i)}return this.dispatchEvent({type:"connected",data:t}),this}disconnect(t){return this.dispatchEvent({type:"disconnected",data:t}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(t,e,i){let s=null,r=null,a=null;const o=this._targetRay,h=this._grip,l=this._hand;if(t&&e.session.visibilityState!=="visible-blurred"){if(l&&t.hand){a=!0;for(const g of t.hand.values()){const p=e.getJointPose(g,i),m=this._getHandJoint(l,g);p!==null&&(m.matrix.fromArray(p.transform.matrix),m.matrix.decompose(m.position,m.rotation,m.scale),m.matrixWorldNeedsUpdate=!0,m.jointRadius=p.radius),m.visible=p!==null}const c=l.joints["index-finger-tip"],f=l.joints["thumb-tip"],d=c.position.distanceTo(f.position),u=.02,_=.005;l.inputState.pinching&&d>u+_?(l.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:t.handedness,target:this})):!l.inputState.pinching&&d<=u-_&&(l.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:t.handedness,target:this}))}else h!==null&&t.gripSpace&&(r=e.getPose(t.gripSpace,i),r!==null&&(h.matrix.fromArray(r.transform.matrix),h.matrix.decompose(h.position,h.rotation,h.scale),h.matrixWorldNeedsUpdate=!0,r.linearVelocity?(h.hasLinearVelocity=!0,h.linearVelocity.copy(r.linearVelocity)):h.hasLinearVelocity=!1,r.angularVelocity?(h.hasAngularVelocity=!0,h.angularVelocity.copy(r.angularVelocity)):h.hasAngularVelocity=!1));o!==null&&(s=e.getPose(t.targetRaySpace,i),s===null&&r!==null&&(s=r),s!==null&&(o.matrix.fromArray(s.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),o.matrixWorldNeedsUpdate=!0,s.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(s.linearVelocity)):o.hasLinearVelocity=!1,s.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(s.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(ig)))}return o!==null&&(o.visible=s!==null),h!==null&&(h.visible=r!==null),l!==null&&(l.visible=a!==null),this}_getHandJoint(t,e){if(t.joints[e.jointName]===void 0){const i=new ui;i.matrixAutoUpdate=!1,i.visible=!1,t.joints[e.jointName]=i,t.add(i)}return t.joints[e.jointName]}}const sg=`
void main() {
